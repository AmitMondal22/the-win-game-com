...
<html lang="en">
    <head>
        ...
        <title>TheGameWin | Result</title>
        
        <meta name="keywords" content="<?php foreach ($ddd as $key) { echo $key->game_name.',';  }?>">
    ...
    <div class="nk-store nk-store-cart">
        <div class="table-responsive">
            ...
            <table class="nk-table"> <!-- nk-store-cart-products -->
                ...
                <tbody>
                <?php foreach ($ddd as $key) { ?>
                        <tr onclick="location.href = '<?php echo base_url(); ?>winres/<?php echo $key->id; ?>';">
                            <td class="nk-product-cart-thumb">
                                <h5 class="h6"></h5>
                                <div class="nk-gap-1"><?php echo $key->id; ?></div>
                                
                            </td>
                            <td class="nk-product-cart-thumb">
                                <h5 class="h6"></h5>
                                <div class="nk-gap-1"><?php echo $key->game_name; ?></div>
                                
                            </td>
                            <td class="nk-product-cart-thumb">
                                <h5 class="h6"></h5>
                                <div class="nk-gap-1"><?php echo $key->mach_date; ?></div><br>
                                <div class="nk-gap-1"><?php echo date('h:i A', strtotime($key->mach_time));  ?></div>
                                
                            </td>
                            <td class="nk-product-cart-thumb">
                                <h5 class="h6"></h5>
                                <a href="<?php echo base_url(); ?>winres/<?php echo $key->id; ?>" class="nk-btn nk-btn-rounded  nk-btn-hover-color-info  nk-btn-color-white"><span class="icon ion-paper-airplane"></span>view</a>
                            </td>
