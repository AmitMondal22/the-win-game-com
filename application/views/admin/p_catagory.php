        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <form action="<?php echo base_url(); ?>act_p_cata" method="post" >
                        <p>Add product Catagory</p>
                        <p><input type="text" name="p_catagory" class="form-control"></p>
                        <p><input type="submit" name="save" value="save" class="btn btn-success btn-block"></p>
                    </form>
                    <table class="table table-striped">
                        ...
                        <tbody>
                          ...
                          <tr>
                            <td><?php echo $key->pca_id ;?></td>
                            <td><?php echo $key->p_catagory ;?></td>
                            <td>
                                <a href="<?php echo base_url(); ?>admin/catagoru/<?php echo $key->pca_id ;?>" class="btn btn-primary">Update</a>
                            </td>

                            <td>
                                <a href="<?php echo base_url(); ?>admin/catagoru-updaet/<?php echo $key->pca_id ;?>" title="" class="btn btn-danger">Delete</a>
                            </td>
                          </tr>
                      <?php } ?>
                        </tbody>
