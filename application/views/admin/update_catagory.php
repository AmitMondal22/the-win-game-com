        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <form action="<?php echo base_url(); ?>upd_catagory" method="post" >

                        <?php foreach ($row as $r) { ?>

                            <input type="hidden" name="cat_id" value="<?php echo $r->pca_id; ?>">
                            
                        <p>Add product Catagory</p>

                        <p><input type="text" name="p_catagory" class="form-control" value="<?php echo $r->p_catagory; ?>"></p>
