        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <form action="<?php echo base_url('ind-admin'); ?>" method="post">
                        <div class="row text-dark">
                            <div class="col-md-6">
                                <p>Name</p>
                                <p><input type="text" id="" class="form-control" name="name"></p>
                                <p>gender</p>
                                <p style="margin-bottom: 31px;"><input type="radio" value="Male" name="gen" id=""> Male<input type="radio" name="gen" value="Female" id="" style="margin-left:10px;"> Female<input type="radio" name="gen" id="" style="margin-left:10px;" value="Others"> Others</p>
                                <p>Admin role</p>
                                <p>
                                    <select name="adminRole" id="" class="form-control">
                                        <option value="">select</option>
                                        <?php foreach ($row as $key) { ?>
                                        <option value="<?php echo $key->role_id; ?>"><?php echo $key->type_name; ?></option>
                                        <?php } ?>
                                    </select>
                                </p>
                            </div>
                            <div class="col-md-6">
                                ...
                                <p>Date of birth</p>
                                <p><input type="date" name="dob" id="" class="form-control"></p>
                                <p>Password</p>
                    ...
                    <p><input type="submit" value="SAVE" class="btn btn-success btn-block"></p>
                    </form>
                </div>
                <!-- /.container-fluid -->
