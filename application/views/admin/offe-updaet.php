        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
<?php foreach ($z as $ke) {  ?>
                    <form action="<?php echo base_url(); ?>off-update" method="post" enctype="multipart/form-data">
                        <input type="hidden" name="offer_id" value="<?php echo $ke->off_id ; ?>">
                        <p>select Game</p>
                        <p>
                            <select name="game" class="form-control">
                                <option>select game</option>
                                <?php foreach ($ro as $k) { ?>
                                <option value="<?php echo $k->id; ?>" <?php if ($ke->game_id == $k->id) {
                                    echo "selected";
                                }  ?>><?php echo $k->id ,", ",$k->game_name; ?></option>
                            <?php } ?>
                            </select>
                        </p>
                        <p>Offer Name</p>
                        <p><input type="text" name="off_name" value="<?php echo $ke->off_name; ?>" class="form-control"></p>
                        <p>Gift</p>
                        <p><input type="text" name="gift" value="<?php echo $ke->gift; ?>" class="form-control"></p>
                        <p>img size-1017x476</p>
                        <p><img src="<?php echo base_url();?>/off_img/<?php echo $ke->img; ?>" width="100px"></p>
                        <p>
