...
<html lang="en">
    <head>
        ...
        <title>TheGameWin|Sing Up</title>
...
<div class="container">
    ...
    <div class="nk-store nk-store-checkout">
        <h3 class="nk-decorated-h-2"><span><span class="text-main-1">YOUR</span> Details</span></h3>

        <!-- START: Billing Details -->
        <div class="nk-gap"></div>
        <form action="<?php echo base_url(); ?>save-info" method="post" class="nk-form">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="nk-gap-1"></div>
                        ...
                        <div class="col-sm-12">
                            ...
                            <label for="date">Date of Birth 18+<span class="text-main-1">*</span>:</label>
                            <input type="date" class="form-control required" name="date" id="date" max="<?php echo (date('Y')-18).'-'.date('m-d'); ?>" min="<?php echo (date('Y')-40).'-'.date('m-d'); ?>"  >
                        
                    
                    <div class="nk-gap-1"></div>
                    <!-- <label for="company">User name <span class="text-main-1">*</span>:</label><br>
                    <label><div id="divusername"></div></label> -->
                    <input type="hidden" class="form-control" name="username" id="company" >
                    <!-- <div class="nk-gap-1"></div> -->
...
<div class="row vertical-gap">
                        <div class="col-sm-6">
                            ...
                            <input type="tel" class="form-control required" name="mobileno" id="contact">
                            
                        </div>
                        <div class="col-sm-6">
                            

                            <label for="address">Whatsapp <span class="text-main-1">*</span>: <input type="checkbox" id="check"></label>
                    <input type="text" class="form-control required" name="whatsappno" id="permanent">
                        </div>
                    </div>
                ...
                <div class="col-lg-6">
                	 ...
                	 <label for="country-sel">Gender <span class="text-main-1">*</span>:</label>
                    <select name="gender" class="form-control required" id="country-sel">
                    ...
                    <div class="nk-gap-1"></div>
                        <label for="country-sel">My Games <span class="text-main-1">*</span>:</label>
                    <select name="gameid" class="form-control required" id="country-sel">
                        <option value="">Select a Game...</option>
<?php foreach ($grow as $key) { ?>
                        <option value="<?php echo $key->game_id; ?>"><?php echo $key->games; ?></option>
<?php } ?>
                    </select>
                    <div class="nk-gap-1"></div>
                    ...
                    <div class="row vertical-gap">
                        <div class="col-sm-12">
                            <label for="fname">Game id <span class="text-main-1">*</span>:</label>
                            <input type="text" class="form-control required" name="gid" id="fname">
                        </div>
                        
                    </div>
                    <label for="city">Create New Password <span class="text-main-1">*</span>:</label>
                    <input type="password" class="form-control required" name="password" id="city">
                </div>
                
                <div class="col-lg-12">
                    <a href="<?php echo base_url(); ?>terms-conditions">Terms & Conditions</a>
                	<input type="submit" name="" value="SIGN UP" class="nk-btn nk-btn-rounded nk-btn-color-main-1 btn-block">
                </div>
            </div>
        </form>
        <!-- END: Billing Details -->
