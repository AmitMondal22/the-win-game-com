...
<html lang="en">
    <head>
        ...
        <title>TheGameWin | About</title>
        <meta name="keywords" content="TheGameWin About,TheGameWin About">
...
<div class="container">
    ...
    <div class="col-lg-6   d-none d-lg-block">
                  ...
                  <img src="<?php echo base_url(); ?>use/assets/img/about.jpg" alt="" width="100%">
                </div>
            </div>
    <div class="col-lg-6">
                ...
                <div class="nk-box-2 bg-dark-2">
                    <h4>THE GAME WIN</h4>
                    <p>
                     IS A ONLINE MOBILE GAMING YOURNAMENT PLATFORM OF NOW MOST POPULAR GAME <b style="color: red;">‘GERENA FREE – FIRE’</b>.IT IS A WEBSITE WHERE SEVERAL TOURNAMENTS DETAILS WILL BE GIVEN OF DIFFERENT TIMES OF THE DAY.<b style="color: red;">THE GAME WIN</b> HAS DAILY CONTESTS & USERS CAN WIN EASILY REAL CASH BI PLAYING GAMES DAILY BASIS BY USING THEIR SKILLS .IT IS AVAILABLE FOR ALL USERS WHERE WINNING LEADERBOARD ALSO FOR ANYBODY.</p>
                </div>
            </div>
