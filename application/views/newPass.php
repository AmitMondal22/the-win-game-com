...
<html lang="en">
    <head>
        ...
        <title>TheGameWin|New Password</title>
...
<div class="nk-gap  d-none d-lg-block"></div>
                <div class="nk-feature-2">
                    ...
                    <div class="nk-feature-cont text-center">
                        ...
                        <form action="<?php echo base_url(); ?>userNewPassword" method="post" id="form1">
                        <input type="hidden" name="id" value="<?php echo $us_id ?>">
                        <input type="hidden" id="g-recaptcha-response" name="g-recaptcha-response">
                        <input type="hidden" name="action" value="validate_captcha">
                        
                        <div class="input-group">
                            <input type="password" name="passrord" class="required password form-control" placeholder="Enter New Password Address.." >
...
<?php if($key->u_status == "deactive"){redirect(base_url());} ?>
