...
<html lang="en">
    <head>
        ...
        <title>TheGameWin | <?php foreach ($all_video as $allv) { if ($vi==$allv['contentDetails']['videoId']) { echo $allv['snippet']['title']; }}?> </title>
        <meta name="keywords" content="<?php foreach ($all_video as $allv) { if ($vi==$allv['contentDetails']['videoId']) { echo $allv['snippet']['title']; }}?>">
...
<div class="container">
    <div class="row vertical-gap">
        <?php foreach ($all_video as $allv) { if ($vi==$allv['contentDetails']['videoId']) { ?>
            
        <div class="col-lg-12">
            <a href="">
            <div class="card">
                
                  <iframe width="100%" height="400" src="https://www.youtube.com/embed/<?php echo $allv['contentDetails']['videoId']; ?>" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
